...
int num_custs_arrived, num_custs_departed;
...
void timing(void){ /* Timing function */
    ...
    if(next_event_type == 2){
        num_custs_departed++;
        // printf("Next event: Customer %d Departure\n", num_custs_delayed);
        fprintf(outfile1, "Next event: Customer %d Departure\n", num_custs_departed);
    }
    else if(next_event_type == 1){
        num_custs_arrived++;
        // printf("Next event: Customer %d Arrival\n\n", num_custs_delayed + 1);
        fprintf(outfile1, "Next event: Customer %d Arrival\n\n", num_custs_arrived);
    }
...
void arrive(void){ /* Arrival event function */
    ...
    if(server_status == BUSY){
        ...
        // cout << "---------Number of customers delayed: " << num_custs_delayed << "---------"<<"\n\n";
        fprintf(outfile1, "---------Number of customers delayed: %d---------\n\n", num_custs_delayed);
